...
const Home = () => {
    ...
    return (
        <div className="min-h-screen selection:bg-purple-500/30 overflow-x-hidden relative bg-black">
            <ModernBackground />

            {/* Scroll Progress Bar */}
            <motion.div
                className="fixed top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 z-[100] origin-[0%]"
                style={{ scaleX }}
            />
                ...
                >
                    <div className="text-center">
                        ...
                        <div className="mb-12 cursor-default relative group">
                            <div className="absolute inset-0 bg-purple-600/20 blur-[100px] group-hover:bg-purple-600/30 transition-all duration-500 rounded-full" />
                            <ParticleTextEffect
                                words={[
                                    'LearNex',
                                    'Smart ERP',
                        ...
                        >
                            <motion.button
                                ...
                                className="group relative overflow-hidden px-10 py-5 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-2xl shadow-[0_0_20px_rgba(124,58,237,0.4)] transition-all duration-300 flex items-center gap-3"
                            >
            ...
            <section className="py-32 relative overflow-hidden bg-black">
                <div className="absolute inset-0 bg-purple-600/5 blur-[120px] rounded-full -translate-y-1/2" />
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
                        {[
                            { label: 'Active Students', value: stats.students, color: 'from-blue-600 to-cyan-600', glow: 'shadow-blue-500/20', icon: Users },
                            { label: 'Expert Faculty', value: stats.faculty, color: 'from-purple-600 to-pink-600', glow: 'shadow-purple-500/20', icon: GraduationCap },
                            { label: 'Smart Courses', value: stats.courses, color: 'from-amber-600 to-orange-600', glow: 'shadow-orange-500/20', icon: BookOpen },
                            { label: 'Satisfaction Rate', value: stats.satisfaction, color: 'from-green-600 to-emerald-600', glow: 'shadow-green-500/20', icon: Award, suffix: '%' }
                        ].map((stat, idx) => (
                            <motion.div
                                key={idx}
                                ...
                                className="group relative p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105"
                            >
                                ...
                                <div className={`text-4xl sm:text-5xl font-black bg-gradient-to-r ${stat.color} bg-clip-text text-transparent mb-2 tabular-nums drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]`}>
                                    {stat.value.toLocaleString()}{stat.suffix || '+'}
                                </div>
                                <div className="text-slate-400 font-bold uppercase tracking-wider text-xs">{stat.label}</div>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-32 relative overflow-hidden bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-5xl sm:text-7xl font-black text-white mb-6 tracking-tight drop-shadow-[0_0_30px_rgba(168,85,247,0.3)]">
                            Engineered for <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Excellence</span>
                        </h2>
                        ...
                        {features.map((feature, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="group relative bg-white/5 backdrop-blur-md rounded-[2.5rem] p-10 shadow-2xl transition-all duration-300 border border-white/10 hover:border-purple-500/30 overflow-hidden"
                                >
                                    <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 blur-2xl`} />
                                    ...
                                    {/* Feature Content */}
                                    <h3 className="relative text-2xl font-black text-white mb-4 group-hover:text-purple-400 transition-colors">
                                        {feature.title}
                                    </h3>
                                    <p className="relative text-slate-400 mb-8 leading-relaxed text-lg font-light">
                                        {feature.description}
                                    </p>
                                    ...
                                    <div className="relative grid grid-cols-1 gap-3">
                                        {feature.highlights.map((highlight, idx) => (
                                            <div key={idx} className="flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/5 group-hover:bg-white/10 transition-colors">
                                                <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${feature.color} shadow-[0_0_10px_rgba(255,255,255,0.5)]`} />
            ...
            <section className="py-32 px-4 relative bg-black overflow-hidden">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="max-w-6xl mx-auto relative rounded-[4rem] overflow-hidden bg-white/5 border border-white/10 backdrop-blur-3xl"
                >
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 via-transparent to-blue-600/20 blur-[100px]" />
                    ...
                    <div className="relative py-24 px-8 text-center">
                        <h2 className="text-5xl sm:text-7xl font-black text-white mb-8 tracking-tighter drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                            Ready to Elevate Your <br />
                            <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Educational Experience?</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={() => navigate('/login')}
                                className="px-12 py-5 bg-white text-black font-black rounded-2xl shadow-2xl flex items-center gap-3 hover:bg-slate-100 transition-all mx-auto sm:mx-0 text-lg"
                            >
                                Get Started Now
            ...
            {/* Footer */}
            <footer className="bg-black text-slate-500 py-20 border-t border-white/10 relative overflow-hidden">
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 opacity-50" />
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid md:grid-cols-4 gap-12 mb-16">
                        <div className="col-span-2">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="p-2.5 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl shadow-[0_0_20px_rgba(168,85,247,0.4)]">
                                    <GraduationCap className="w-8 h-8 text-white" />
                                </div>
                                <span className="text-white font-black text-4xl tracking-tighter">LearNex</span>
                            </div>
                            ...
                            <div className="flex gap-4">
                                {[Globe, MessageSquare, Users].map((Icon, i) => (
                                    <motion.div
                                        key={i}
                                        whileHover={{ y: -5, color: '#fff', backgroundColor: 'rgba(255,255,255,0.1)' }}
                                        className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center cursor-pointer transition-all border border-white/5"
                                    >
