            ...
            <div className="animate-fade-in-up max-w-5xl mx-auto space-y-8 pb-10">
                <div className="relative mb-48 md:mb-32">
                    ...
                    <div className="relative h-32 md:h-48 w-full rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        {/* Glow Effect Layer */}
                        <div className="absolute inset-0 bg-gradient-to-r from-[#3385DB] via-[#0066CC] to-[#004C99] blur-3xl opacity-50 animate-pulse-slow"></div>
                        ...
                        {/* Outer Glow */}
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#2563EB] dark:from-[#60A5FA] via-[#3385DB] to-[#004C99] blur-2xl opacity-20 dark:opacity-40 -z-10"></div>
                    </div>
                ...
                <div className="sticky top-4 z-30 flex justify-center pb-8 animate-fade-in-up">
                    <div className="flex items-center gap-1 p-1.5 bg-[#E5E7EB]/70 dark:bg-[#242B3D]/70 backdrop-blur-2xl border border-[#E2E5E9]/20 dark:border-[#3D4556]/20 rounded-full shadow-2xl shadow-slate-200/50 dark:shadow-black/50 overflow-x-auto max-w-full no-scrollbar">
                        {tabs.map((tab) => {
                            const Icon = tab.icon;
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isActive
                                            ...
                                            : "text-[#64748B] dark:text-[#868D9D] hover:text-slate-700 dark:hover:text-slate-200 hover:bg-white/50 hover:bg-[#F1F3F7] dark:bg-[#2D3548]"
                                    )}
                                >
                                    {isActive && (
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-0 min-h-[400px]">
                    ...
                    {/* 1. General Details */}
                    {activeTab === 'general' && (
                        <div className="animate-fade-in-up bg-[#E5E7EB]/60 dark:bg-[#242B3D]/60 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-[#E2E5E9]/40 dark:border-[#3D4556]/40 relative overflow-hidden">
                            ...
                            <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-8 flex items-center gap-2 border-b border-[#E2E5E9] dark:border-[#3D4556] pb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                                <div className="space-y-2 group">
                                    ...
                                    <p className="w-full p-4 bg-[#E5E7EB]/50 dark:bg-[#1A1F2E]/50 border border-indigo-50 dark:border-slate-800 rounded-2xl font-bold text-slate-600 dark:text-slate-300 shadow-sm">{profile.admissionNumber}</p>
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <p className="w-full p-4 bg-[#E5E7EB]/50 dark:bg-[#1A1F2E]/50 border border-indigo-50 dark:border-slate-800 rounded-2xl font-bold text-slate-600 dark:text-slate-300 shadow-sm">{profile.department}</p>
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-4 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/20 focus:border-indigo-500 outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
                                    />
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <div className="w-full p-4 bg-[#E5E7EB]/50 dark:bg-[#1A1F2E]/50 border border-indigo-50 dark:border-slate-800 rounded-2xl font-bold text-slate-600 dark:text-slate-300 shadow-sm flex items-center justify-between">
                                ...
                                <div className="space-y-2 md:col-span-2 group">
                                    ...
                                    <p className="w-full p-4 bg-indigo-50/50 dark:bg-slate-900/50 border border-indigo-100 dark:border-slate-800 rounded-2xl font-bold text-indigo-400 flex items-center gap-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                                <div className="space-y-2 group">
                                    ...
                                    <input
                                        ...
                                        value={formData.name}
                                        disabled
                                        className="w-full p-4 bg-[#E5E7EB]/50 dark:bg-[#1A1F2E]/50 border border-transparent rounded-2xl font-bold text-[#64748B] dark:text-[#868D9D] cursor-not-allowed"
                                    />
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-4 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-teal-100 dark:focus:ring-teal-900/20 focus:border-teal-500 outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
                                    />
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full p-4 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-teal-100 dark:focus:ring-teal-900/20 focus:border-teal-500 outline-none transition-all appearance-none disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
                                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                                <div className="space-y-2 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-4 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-amber-100 dark:focus:ring-amber-900/20 focus:border-amber-500 outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
                                    />
                                </div>
                                <div className="space-y-2 group">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full p-4 pl-12 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-amber-100 dark:focus:ring-amber-900/20 focus:border-amber-500 outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
                                        />
                        ...
                        <div className="animate-fade-in-up bg-[#E5E7EB]/60 dark:bg-[#242B3D]/60 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-[#E2E5E9]/40 dark:border-[#3D4556]/40 relative overflow-hidden">
                            ...
                            <div className="space-y-2 group">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-6 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-bold text-[#475569] dark:text-[#B8BDC6] focus:ring-4 focus:ring-rose-100 dark:focus:ring-rose-900/20 focus:border-rose-500 outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent min-h-[150px] resize-none leading-relaxed"
                                    ...
                                    <div key={platform} className="space-y-2 group">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full p-4 pl-12 bg-[#E5E7EB]/80 dark:bg-[#1A1F2E]/80 border border-[#E2E5E9] dark:border-[#3D4556] rounded-2xl font-medium text-[#475569] dark:text-[#B8BDC6] text-sm focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900/20 focus:border-[#2563EB] dark:border-[#60A5FA] outline-none transition-all disabled:bg-slate-50/50 disabled:text-[#64748B] dark:text-[#868D9D] disabled:border-transparent"
