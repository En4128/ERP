...
const DesktopSidebar = ({ className, children, ...props }) => {
    ...
    return (
        <motion.div
            className={cn(
                "h-full px-4 py-2 hidden md:flex md:flex-col bg-white dark:bg-slate-900 w-[300px] flex-shrink-0 border-r border-slate-100 dark:border-slate-800",
                className
            )}
            animate={{
    ...
    return (
        <Link
            ...
            className={cn(
                ...
                isActive
                    ? "bg-[#0066CC]/10 text-[#0066CC] dark:bg-blue-500/20 dark:text-blue-400 font-bold border border-blue-200/50 dark:border-blue-800/50 shadow-sm"
        ...
        >
            <span className={cn(
                ...
                isActive ? "text-[#0066CC] dark:text-blue-400" : "text-slate-400 dark:text-slate-600"
            )}>
                {link.icon}
            </span>
            <motion.span
                        ...
                        <AnimatePresence mode="wait">
                            {open && (
                                ...
                                >
                                    ...
                                    <p className="text-[10px] text-[#0066CC] font-black tracking-widest uppercase">{role} PORTAL</p>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </div>
